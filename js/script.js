...
const getWeatherByCityName = async cityString => {
	let city;
	//checkime siin kui APIst saadud linnanimes on peale linna ja riigi veel vahepeal midagi ss votab aind esimesest komast eespool oleva ja viimasest komast järgneva teksti
...
const updateForecast = forecast => {
	...
	forecast.forEach(day => {
		...
		let dayName = dayOfWeek(day.dt * 1000); // korrutame et millisec saada
